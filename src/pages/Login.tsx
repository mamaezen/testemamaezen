    ...
    <div className="min-h-screen bg-gradient-to-br from-[hsl(var(--bg-gradient-start))] via-[hsl(var(--bg-gradient-middle))] to-[hsl(var(--bg-gradient-end))] flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 py-8 relative z-10">
        ...
        <div className="w-full max-w-sm space-y-3">
          <div className="p-5 rounded-2xl bg-card/50 backdrop-blur-xl border border-border/30 shadow-2xl space-y-4">
            ...
            <Button
              ...
              className="w-full h-13 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-primary-foreground font-bold text-sm rounded-xl shadow-lg shadow-primary/25 transition-all duration-300 hover:shadow-xl hover:shadow-primary/35 hover:scale-[1.01] active:scale-[0.99] disabled:opacity-70 gap-2"
              size="lg"
            >
              {isLoggingIn ? (
              ...
              {!isLoggingIn && <ChevronRight className="w-4 h-4 ml-auto" />}
            </Button>

            {/* Divider */}
            <div className="flex items-center gap-3">
              <div className="flex-1 h-px bg-border/40" />
              <span className="text-[10px] text-muted-foreground/50 uppercase tracking-wider">{isUSA ? 'or' : 'ou'}</span>
              <div className="flex-1 h-px bg-border/40" />
            </div>
            ...
            {!showKeyInput ? (
              <Button
                ...
                className="w-full h-11 rounded-xl border-border/50 text-foreground hover:bg-primary/5 hover:border-primary/30 transition-all gap-2"
              >
              ...
              <div className="space-y-2.5">
                <Input
                  ...
                  maxLength={50}
                  className="h-11 rounded-xl bg-muted/50 border-border/50 text-center font-mono tracking-widest text-sm"
                />
                <Button
                  onClick={async () => {
                  ...
                  className="w-full h-11 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-primary-foreground font-bold rounded-xl shadow-lg gap-2"
                >
                  {activatingKey ? (
